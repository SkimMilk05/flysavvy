   ...
   */
   ...
   fetch("https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/pricing/v1.0", {
         ...
         .then(response => {
          ...
          /*
         .then(key => { //then, with the jason format,
            this.setState({
               sessionKey: String(key) //data has been loaded
            })
         })
         */
...
/*
   ...
   unirest.get("https://cors-anywhere.herokuapp.com/ https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/pricing/uk2/v1.0/"+{sessionKey}+"?pageIndex=0&pageSize=10")
   .header("X-RapidAPI-Host", "skyscanner-skyscanner-flight-search-v1.p.rapidapi.com")
...
*/
 /*     
   ...
   render() { //runs before componentDidMount() method
      ...
      var { isLoaded, sessionKey, items} = this.state; //access properties inside state
